...
echo '<table class="form-table">';
     ...
     printNumberInput($devOptions, __('Upper left corner x', 'advanced-iframe'), 'show_part_of_iframe_x', __('Specifies the offset in pixel from left of the upper left corner. Shortcode attribute: show_part_of_iframe_x=""', 'advanced-iframe'));
     printNumberInput($devOptions, __('Upper left corner y', 'advanced-iframe'), 'show_part_of_iframe_y', __('Specifies the offset in pixel from top of the upper left corner. Shortcode attribute: show_part_of_iframe_y=""', 'advanced-iframe')); 
