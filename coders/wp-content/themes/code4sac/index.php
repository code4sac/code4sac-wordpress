...
$(document).ready(function(){
		var delay = 200;
		var left = 0;
		var height = $('.landing-text-wrapper').outerHeight();
		var toAnimate = $('.animate');

		$('.landing-header button').click(function(){
			toAnimate.animate({'top': '4px'}, 300, function(){
				toAnimate.animate({'top':'-400px'}, 300 );
				
			});
			$('.get-involved div').css({'height': height, 'margin-bottom': height*-1, 'margin-top': (height*-1)+30}).delay(500).show().each(function(){
						$(this).delay(delay).animate({'left': left+'%'}, 200)
						delay = delay + 200;
						left = left + 33.33333333333;
					});
		});
});
</script>
	<div class="landing-header">
		...
		<button class="animate">How to Get Involved<span>&rarr;</span></button>
		<div class="get-involved">
			<a href="https://groups.google.com/forum/#!forum/code4sac"><div>
				<h4>Join The Conversation</h4>
				<p>Check out our google groups discussion and see what we're up to.</p>
			</div></a>
			<a href="/events"><div>
				<h4>Meet Up</h4>
				<p>Join us for one of our meetups every wednesday at the Hacker Lab.</p>
			</div></a>
			<a href="/adopt-a-thing"><div>
				<h4>Our Projects</h4>
				<p>See what we're currently working on. Featured Project: Adopt-a-Thing</p>
			</div></a>
		</div>
		</div>
	</div>
...
<text transform="matrix(1 0 0 1 -2321 -1309)" font-family="'Courier-Bold'" font-size="177.3347">&lt;/&gt;</text>
			...
			<h5>Coders</h5>
			<p>Coders bring our ideas and hard work to fruition, they are the backbone that makes our organization possible. We utilize coders from all skill levels and disciplines to create engaging and robust civic apps.</p>
		</div>
		<div class="col col-4">
...
<path d="M68.736,69.021c0-1.055,0-2.127,0-3.203H80.33h1.066c1.77,0,3.203-1.435,3.203-3.202V18.841v-1.067
	...
	L19.833,61.549L19.833,61.549z"></path>
			...
			<h5>Designers</h5>
			<p>Dazzle us with your sense of aesthetics and form. Create interfaces and design components that will make our apps beautiful and functional.</p>
		</div>
		<div class="col col-4">
...
<path d="M52.207,50.882c3.057-2.678,3.392-3.976,3.423-4.297c0.006-0.054,0.003-0.082,0.003-0.084  c-0.056-0.283-0.267-0.574-0.576-0.857c-0.372-0.338-0.895-0.663-1.507-0.943c-1.133-0.52-2.554-0.88-3.817-0.88  c-1.239,0-2.634,0.35-3.757,0.855c-0.613,0.274-1.143,0.596-1.525,0.932c-0.334,0.293-0.558,0.598-0.616,0.894  c0,0-0.001,0.018,0,0.044c0.009,0.235,0.22,1.528,3.427,4.337l0.77,0.674l-4.085,27.847l4.403,5.211l0.794,0.938l0.591,0.701  l0.592-0.7l0.793-0.938l4.404-5.21l-4.084-27.849L52.207,50.882z"></path>
			...
			<h5>Hustlers</h5>
			<p>Calling all marketers, social media mavens, scribes and project managers we need you to help
spread the word about our projects and administer guidance to the team.</p>
		</div>
		<div class="col col-4">
...
<rect x="40.064" width="59.928" height="4.231"></rect>
			...
			<p>If you don’t think you have anything to offer, you’re wrong! We’re always looking for members to help us understand and solve community issues as subject experts, problem solvers, app testers and mappers.</p>
		</div>
